...
$query_stock = $con->query("create table `produtos`(codigo_produto int(255) not null primary key auto_increment, nome varchar(40) unique, preco_compra varchar(6), preco_venda varchar(6), responsavel varchar(100), codigo_barras varchar(15), quantidade_stock int(6), quantidade_entrada varchar(6), dataFab varchar(60), dataExp varchar(60), data_entrada varchar(60), editado tinyint)");
