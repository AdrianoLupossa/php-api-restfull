...
$query_stock = $con->query("create table `produtos`(codigo_produto int(255) not null primary key auto_increment, nome varchar(40), tipo_produto varchar(60), preco_compra varchar(6), preco_venda varchar(6), qtdUnit int(6), qtdBlade int(6), quantidade_entrada varchar(6), dataVencimento varchar(60), data_entrada varchar(60), responsavel varchar(100), editado tinyint)");
